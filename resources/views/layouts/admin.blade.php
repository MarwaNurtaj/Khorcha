                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{url('dashboard')}}"><i class="fas fa-images"></i> Banner</a></li>
                            <li><a href="{{url('dashboard')}}"><i class="fas fa-comments"></i> Contact Message</a></li>
                            <li><a href="{{url('dashboard')}}"><i class="fas fa-globe"></i> Live Site</a></li>
